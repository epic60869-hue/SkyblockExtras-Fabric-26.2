...
public class PetOverlay {
    ...
    private static long xpToLevelCap(int level,String rarity,String name){String n=name.toLowerCase(Locale.ROOT);if(n.contains("golden dragon")||n.contains("jade dragon")||n.contains("rose dragon")){if(level>=200)return 210_255_385L;if(level>=102)return 25_358_785L+(long)(level-102)*1_886_700L;if(level>=101)return 25_353_230L;}return maxXpForRarity(rarity);}
